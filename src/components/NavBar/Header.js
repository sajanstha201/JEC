...
function Header(){
    return(
        <>
            <div className="fixed z-10 top-0 left-0 w-full  flex flex-col items-center md:flex-row md:justify-between md:items-start p-1 text-2xl" style={{backgroundColor:'rgba(0,0,0,0.5)'}}>
                {/* Logo Section */}
                <div className="logo-section md:mb-0 md:ml-4 flex justify-center md:justify-start w-full md:w-auto">
               <Link to={"/"}>     <img src={logo} alt="Logo of JEC" className="h-[90px] w-[170px]" /> </Link>
                </div>
